...
# Crime Recidivism Analysis

Crime Types

1. Analyze different crime types
2. Visualize
3. Use 2 machine learning models, Logistic regression and Random Forest
4. Compare and Analyze differences (They behave similarly)
