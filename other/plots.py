...
sns.countplot(x=valid_descents, palette="Set2", edgecolor="black")
...
required_columns = ['Crm Cd Desc', 'Crm Cd 1', 'Crm Cd 2', 'Crm Cd 3', 'Crm Cd 4', 'Weapon Desc', 'Premis Desc']
...
if 'Closed' in resolution_data.columns and 'Open' in resolution_data.columns:
    resolution_data['Resolution Rate'] = resolution_data['Closed'] / (resolution_data['Open'] + resolution_data['Closed'])
else:
...
if 'Resolution Rate' in resolution_data.columns:
    ...
    plt.figure(figsize=(12, 8))
    sns.barplot(x='Crm Cd Desc', y='Resolution Rate', data=resolution_data, palette='viridis')

    plt.title('Crime Resolution Rates by Crime Type', fontsize=18, fontweight='bold')
